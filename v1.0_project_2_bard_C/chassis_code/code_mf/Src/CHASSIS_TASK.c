...
{
    osDelay(2000);
    dm_motor_mode_set(CMD_MOTOR_MODE, DM8009P_01_RIGHT_BIG_LEG_FRONT);
    osDelay(1);
    dm_motor_mode_set(CMD_MOTOR_MODE, DM8009P_02_LEFT_BIG_LEG_FRONT);
    osDelay(1);
    dm_motor_mode_set(CMD_MOTOR_MODE, DM8009P_03_LEFT_SMALL_LEG_BEHIND);
    osDelay(1);
    dm_motor_mode_set(CMD_MOTOR_MODE, DM8009P_04_RIGHT_SMALL_LEG_BEHIND);
    osDelay(1);
...
{
    PID_calc(&chassis_DM8009_01_speed_pid, DM8009P_01_RIGHT_BIG_LEG_FRONT.return_speed_rpm, chassis_DM8009_01_speed_set_loop);
...
{
    PID_calc(&chassis_DM8009_02_speed_pid, DM8009P_02_LEFT_BIG_LEG_FRONT.return_speed_rpm, chassis_DM8009_02_speed_set_loop);
...
{
    PID_calc(&chassis_DM8009_03_speed_pid, DM8009P_03_LEFT_SMALL_LEG_BEHIND.return_speed_rpm, chassis_DM8009_03_speed_set_loop);
...
{
    PID_calc(&chassis_DM8009_04_speed_pid, DM8009P_04_RIGHT_SMALL_LEG_BEHIND.return_speed_rpm, chassis_DM8009_04_speed_set_loop);
