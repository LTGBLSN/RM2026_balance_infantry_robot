                 ...
                 int16_t shoot_id3, int16_t state )
{
    ...
    CAN1_gimbal2chassis_A(yaw_id1,0,0,state);
    CAN1_gimbal2chassis_B(SHOOT_2006_ID3_GIVEN_SPEED,0,0,0);
