...
void leg_torque_47_compute()
{
    if(rcData.rc.s[0] == 1)
    {
        left_leg_joint_2_leg_parameters.virtual_joint_theta47_tor = (float)rcData.rc.ch[3]/660.0f * 40.0f ;
        right_leg_joint_2_leg_parameters.virtual_joint_theta47_tor = (float)rcData.rc.ch[1]/660.0f * 40.0f ;
...
//        leg_torque_47_pid_loop();
        left_leg_joint_2_leg_parameters.virtual_joint_theta47_tor = 0 ;
        right_leg_joint_2_leg_parameters.virtual_joint_theta47_tor = 0 ;
