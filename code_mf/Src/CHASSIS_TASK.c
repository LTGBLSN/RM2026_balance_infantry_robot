...
{
    DM8009P_01_LEFT_FRONT.give_angle = 0.1f ;
    ...
    DM8009P_02_RIGHT_FRONT.give_angle = 0.0f ;
    ...
    DM8009P_03_RIGHT_BEHIND.give_angle = -0.0f ;
    ...
    DM8009P_04_LEFT_BEHIND.give_angle = -0.1f ;
